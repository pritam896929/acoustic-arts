            ...
            <div class="row g-4">
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item h-100 border">
                        <div
                            ...
                            <h2 class="text-primary mb-4">Redefining Reliability in Commercial Audio
                            </h2>
                ...
                <div class="col-lg-5 col-md-6 wow fadeInUp border p-1" style="background: #191C24" data-wow-delay="0.1s">
                    <div class="team-item h-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/img/cloud - Copy.png') }}" alt="Modern boardroom with Biamp system"
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">Cloud Mixers & Zone Controllers
                            </h5>
                            <span class="">Renowned for their reliability and intuitive operation, Cloud mixers and zone
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">Cloud Amplifiers</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">Cloud Paging & Announcements Systems</h5>
                            <span class="">Trusted for crystal-clear voice transmission, Cloud paging solutions ensure clear
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">Cloud Networked Audio Solutions</h5>
                            <span class="">Flexible, installation-friendly systems that integrate seamlessly with modern AV
                                infrastructures.
                            </span>
                        </div>
                    </div>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary p-4 h-100 d-flex flex-column justify-content-center border">
                        <h5 class="text-uppercase text-primary mb-3">Perfectly Tuned for Every Voice</h5>
                        <p class="text-white mb-0">
                           Acoustic Arts Pvt. Ltd. proudly distributes Cloud Electronics — a globally trusted name in commercial audio, renowned for its dependable performance and installation-friendly design. For decades, Cloud has been the choice of hospitality venues, retail chains, leisure facilities, and corporate environments worldwide.
                        </p>
                        <p class="text-white mb-0">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary p-4 h-100 d-flex flex-column justify-content-center border">
                        <h5 class="text-uppercase text-primary mb-3">Cloud Electronics, Engineered for Excellence by Acoustic Arts
                        </h5>
                        <p class="text-white mb-0">
                           As a premier AV solutions provider with over 25 years of experience, Acoustic Arts Pvt. Ltd. is proud to offer Cloud Electronics — a trusted leader in commercial audio solutions. Designed for reliability, clarity, and ease of integration, Cloud products power hospitality, retail, leisure, and corporate environments around the world.
                        </p>
