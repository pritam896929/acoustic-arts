            ...
            <div class="row g-4">
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item h-100 border">
                        <div
                            ...
                            <h2 class="text-primary mb-4">Elevating Excellence in High-Fidelity Sound
                            </h2>
                            <p class="mb-3">
                ...
                <div class="col-lg-5 col-md-6 wow fadeInUp border p-1" style="background: #191C24" data-wow-delay="0.1s">
                    <div class="team-item h-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/img/goldenear2.png') }}" alt="Modern boardroom with Biamp system"
    ...
    <div class="container-xxl py-5 my-5">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-5 col-md-6 wow fadeInUp border p-1" style="background: #191C24" data-wow-delay="0.1s">
                    <div class="team-item h-100 d-flex align-items-center justify-content-center">
                        <img class="img-fluid w-100" src="{{ asset('assets/img/goldenear1.png') }}"
                ...
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item h-100 border">
                        <div
                            class="bg-secondary text-white text-center p-3 h-100 d-flex flex-column justify-content-center rounded-4 shadow-lg">
                            <h2 class="text-primary mb-4">Celebrated Worldwide for High-Fidelity Audio</h2>
                            <p class="mb-3">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">GoldenEar Tower Speakers
                            </h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">GoldenEar Bookshelf Speakers</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">GoldenEar Subwoofers</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border ">
                        ...
                        <div class="bg-secondary text-center p-4">
                            <h5 class="text-uppercase">GoldenEar Soundbars & Surround Solutions</h5>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary p-4 h-100 d-flex flex-column justify-content-center border">
                        <h5 class="text-uppercase text-primary mb-3">Perfectly Crafted for Every Note</h5>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary p-1 h-100 border">
                        <img src="{{ asset('assets/img/goldenear.png') }}" alt="Installation"
