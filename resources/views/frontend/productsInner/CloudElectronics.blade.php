...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Cloud Electronics CVS-C83TB/W -
                Ceiling Speaker</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="/">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Cloud Electronics CVS-C83TB/W -
                        Ceiling Speaker</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="container py-5">
        <div class="row g-4">
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner border rounded">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/img/Cloud Electronics CVS-C83TBW-Ceiling Speaker.png') }}"
                                class="d-block w-100 img-fluid" alt="Product Image">
                        </div>
                    ...
                    <div class="mt-3 d-flex justify-content-center gap-2">
                        <img src="{{ asset('assets/img/Cloud Electronics CVS-C83TBW-Ceiling Speaker.png') }}"
                            class="img-thumbnail" width="80" data-bs-target="#productCarousel" data-bs-slide-to="0"
            ...
            <div class="col-lg-6">
                <h2 class="fw-bold text-capitalize">CVS-C83TB/W - Ceiling Speaker
                    CVS-C83T</h2>
                ...
                <p>The Cloud CVS-C62 (6.5”) and CVS-C83 (8”) are premium two-way coaxial in-ceiling speakers from the Contractor Series, designed for high-quality music reproduction and clear speech reinforcement. With a sleek magnetic grille and finish options in white or black, they integrate seamlessly into any environment.</p>
                <ul class="list-unstyled">
                    <li><strong>Color:</strong> White/Black</li>
                    <li><strong>Available:</strong> <span class="text-success">In stock</span></li>
                    <li><strong>Category:</strong> Ceiling Speakers</li>
