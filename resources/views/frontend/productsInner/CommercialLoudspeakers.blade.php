...
@section('content')
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Commercial Loudspeakers CM20</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="row g-4">
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner border rounded">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/img/biamppoduct1.png') }}" class="d-block w-100 img-fluid"
                                alt="Product Image">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('assets/img/biampproduct-black.png') }}" class="d-block w-100 img-fluid"
                                alt="Product Image">
                        </div>
                        {{-- <div class="carousel-item">
                    ...
                    <div class="mt-3 d-flex justify-content-center gap-2">
                        <img src="{{ asset('assets/img/biamppoduct.png') }}" class="img-thumbnail" width="80"
                            data-bs-target="#productCarousel" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1">

                        <img src="{{ asset('assets/img/biampproduct-black.png') }}" class="img-thumbnail" width="80"
            ...
            <div class="col-lg-6">
                <h2 class="fw-bold text-capitalize">Commercial Loudspeakers CM20</h2>
                ...
                <p>The CM20 Commercial Loudspeaker is a high-quality ceiling speaker designed for both background music and
                    paging applications in commercial environments. With its compact and discreet design.</p>
                <ul class="list-unstyled">
                    <li><strong>Color:</strong> White/Black</li>
                    <li><strong>Available:</strong> <span class="text-success">In stock</span></li>
                    <li><strong>Category:</strong> Loudspeakers</li>
