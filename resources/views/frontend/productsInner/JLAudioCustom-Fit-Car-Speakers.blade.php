...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">JL Audio Custom Fit car speakers</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="/">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">JL Audio Custom Fit car speakers
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="container py-5">
        <div class="row g-4">
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner border rounded">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/img/Custom-Fit-Car1.png') }}" class="d-block w-100 img-fluid"
                                alt="Product Image">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('assets/img/Custom-Fit-Car2.png') }}" class="d-block w-100 img-fluid"
                                alt="Product Image">
                        </div>
                        {{-- <div class="carousel-item">
                    ...
                    <div class="mt-3 d-flex justify-content-center gap-2">
                        <img src="{{ asset('assets/img/Custom-Fit-Car1.png') }}" class="img-thumbnail" width="80"
                            data-bs-target="#productCarousel" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1">

                        <img src="{{ asset('assets/img/Custom-Fit-Car2.png') }}" class="img-thumbnail" width="80"
            ...
            <div class="col-lg-6">
                <h2 class="fw-bold text-capitalize">JL Audio® Custom-Fit Car Midtweeter System
                </h2>
                ...
                <p>The JL Audio CF Custom-Fit Mid-Tweeter System is engineered to upgrade and replace factory mid/tweeter
                    drivers with high-performance components, delivering remarkably clearer, more dynamic sound without
                    needing structural modifications.</p>
                <ul class="list-unstyled">
                    <li><strong>Color:</strong>Black</li>
                    <li><strong>Available:</strong> <span class="text-success">In stock</span></li>
                    <li><strong>Category:</strong> Car Speakers</li>
