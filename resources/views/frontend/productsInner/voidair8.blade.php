...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">void air 8</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="/">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">void air 8</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="row g-4">
                ...
                <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner border rounded">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/img/voidair8red.png') }}" class="d-block w-100 img-fluid"
                                alt="Product Image">
                        </div>
                    ...
                    <div class="mt-3 d-flex justify-content-center gap-2">
                        <img src="{{ asset('assets/img/voidair8red.png') }}" class="img-thumbnail" width="80"
            ...
            <div class="col-lg-6">
                <h2 class="fw-bold text-capitalize">Void air 8</h2>
