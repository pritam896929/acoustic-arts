        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-4">

                        <div class="ps-0">
                            <h3 class="text-uppercase mb-3">Distribution of Products and Product Support</h3>
                ...
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-4">
                        <div class="ps-0">
                            <h3 class="text-uppercase mb-3">Project Management, Installation & Consulting </h3>
                ...
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-4">
                        <div class="ps-0">
                            <h3 class="text-uppercase mb-3">EASE Simulation and Modeling of Space</h3>
