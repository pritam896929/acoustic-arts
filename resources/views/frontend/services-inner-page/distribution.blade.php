...
@section('content')
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-stretch">
            <div class="col-md-6 d-flex">
                <div class="light-black border p-4 w-100 d-flex flex-column justify-content-center">
                    <h1 class="mb-4">Quality > Quantity</h1>
                    <p>
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-stretch flex-md-row-reverse">
            <div class="col-md-6 d-flex">
                <div class="light-black border p-4 w-100 d-flex flex-column justify-content-center">
                    <h1 class="mb-4">Detailed Discussions</h1>
                    <p>
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-stretch">
            <div class="col-md-6 d-flex">
                <div class="light-black border p-4 w-100 d-flex flex-column justify-content-center">
                    <h1 class="mb-4">Guided Choices, Trusted Expertise</h1>
                    <p>
